...
public class DAO {
    ...
    private static com.example.prepare.DAO dao = null;
    ...
    public static synchronized com.example.prepare.DAO getInstance(Context context)
    {
        Log.d(TAG, "getting DAO instance");
        if (dao == null)
        {
            dao = new com.example.prepare.DAO();
