...
public class PlanActivity extends AppCompatActivity implements TasksFragment.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "starting plan activity");
    ...
    public void onFragmentInteraction(int position){
        ...
        PlanActivity.this.startActivityForResult(intent, EDIT_ACTIVITY);
    }
    ...
    public void onAddClick(View view)
    {
        ...
        PlanActivity.this.startActivityForResult(intent, NEW_ACTIVITY);
    }
